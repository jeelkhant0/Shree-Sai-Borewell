...
export function Tractor(props: any) {
    const { scene } = useGLTF("/3d/Tract2.glb");
...
export default function TractorModel() {
    return (
        <div style={{ height: "400px", width: "100%", position: 'relative' }}>
            <Canvas frameloop="always" dpr={[1, 2]} shadows camera={{ fov: 45, position: [0, 0, 10] }} gl={{ alpha: true, preserveDrawingBuffer: true }} style={{ position: 'absolute' }}>
                ...
                {/* Environment removed for memory optimization */}
