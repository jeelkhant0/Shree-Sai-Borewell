...
export default function FiltModel() {
    return (
        <div style={{ height: "280px", width: "100%", position: 'relative' }}>
            <Canvas frameloop="always" dpr={[1, 2]} shadows camera={{ fov: 45, position: [0, 0, 5] }} gl={{ alpha: true, preserveDrawingBuffer: true }} style={{ position: 'absolute', width: '100%', height: '100%', top: 0, left: 0 }}>
